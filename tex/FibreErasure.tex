...
the capacity-level residue is open, see~\textup{[O-1b]}).
  ...
  \subsection{Non-injective projection and fibre structure}
    ...
    a structurally motivated hypothesis (O18 establishes Born--Infeld parity as an equivariant
    symmetry and states the fibre identification as an open problem): under it, Weil blocks

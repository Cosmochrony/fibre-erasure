...
O12's exact rank formula identifies this fingerprint precisely: the increment is carried by the
projective frequency $B = c_1 b_1 + c_2 b_2 + c_3 b_3$, equivalently the pair
$(\alpha,\beta)=(B/A,C/A) \bmod q$, which indexes each block's Weil-representation modulation and
is a structural property of the block label itself, not of the visited elements' central
coordinates.

...
shows that the central phase contributes only the frequency $B$ — preserved by the orbit
dilation $B \mapsto \omega B$ — and not the shape of the block decay, so capacity erasure
holds pointwise within each colour orbit.

...
(stated and motivated; see open problem~\textup{[O-1b]}).
      \end{enumerate}
...
to all $\ell' > \ell$.
  ...
  The rank-level component of the original problem~\textup{[O-1]} (analytical proof
  of~\textup{[H-suff]}) is closed.
  ...
  namely whether the Born--Infeld imprint preserves this fibre-blindness for the full capacity.

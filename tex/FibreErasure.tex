...
light cone on the temporal axis~$n$, orthogonal to the present paper.
  ...
  The monotone reduction of fibre information under BFS coarse-graining is consistent
  with the interpretation of the projective temporal ordering as an emergent direction
  along which physically distinguishable fibre structure is irreversibly coarse-grained
  into the admissible observable algebra.

...
O12's exact rank formula identifies this fingerprint precisely: the increment's realised Fourier
frequencies depend on the block label $c=(c_1,c_2,c_3)$ only through the projective pair
